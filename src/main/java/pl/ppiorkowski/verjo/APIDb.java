...
public class APIDb implements Database {

    private static final JooqLogger log = JooqLogger.getLogger(APIDb.class);
    ...
    @Override
    public List<SchemaDefinition> getSchemata() {
        return null;
    }
    ...
    public void setProperties(Properties properties) {
        log.info("Setting properties in APIDb");
    }
